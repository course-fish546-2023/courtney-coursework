...
This is a report created using RMarkdown. It includes code for downloading a multi-fasta file and annotating it using blast.

Blast software can be downloaded [here](https://ftp.ncbi.nlm.nih.gov/blast/executables/blast+/LATEST/).
...
#this chunk works but is not consistent with the assignement instructions (it uses a .fasta file instead \# of a .tab)
